...
/* Changelog */
/* June 23 2018 Zahid Mahir - Add pricing to the part struct, and to all methods. */
...
int main(void)
{
  ...
  for (;;) {
    printf("Enter operation code: i|s|u|r|q\n");
    scanf(" %c", &code);
 ...
 *         change in quantity and updates the database.   *                   *
 **********************************************************/
void update_quantity(void)
{
  int i, number, change;
 ...
 *        hand, and price. Parts are printed in the       *
